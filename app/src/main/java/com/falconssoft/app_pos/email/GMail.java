package com.falconssoft.app_pos.email;

import android.util.Log;

import com.falconssoft.app_pos.models.ShareValues;
...
public class GMail {
    ...
    private final String emailHost = ShareValues.hostName; // related of sender email
...
//            Log.i("GMail", "toEmail: " + toEmail);
        emailMessage.addRecipient(Message.RecipientType.TO,
                new InternetAddress(ShareValues.recipientName));
//        }
